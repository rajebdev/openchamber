...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolPart.codesearchResults': '在 {files} 个文件中找到 {count} 个匹配项',
  'chat.toolPart.contentType': '内容类型: {type}',
  'chat.toolPart.structuredData': '结构化数据',
  'chat.toolPart.enteringPlanMode': '进入规划模式',
  'chat.toolPart.exitingPlanMode': '退出规划模式',
  'chat.toolPart.taskRunning': '任务运行中',
  'chat.toolPart.taskCompleted': '任务已完成',
  'chat.toolPart.monitorOutput': '监视器输出',
  'chat.toolPart.renameCompleted': '重命名已完成',
  'chat.toolPart.renameAvailable': '可重命名',
  'chat.toolPart.editFailed': '编辑失败',
  'chat.toolPart.editApplied': '编辑已应用',
  'chat.toolPart.foundReferences': '找到 {count} 个引用',
  'chat.todo.total': '总计',
