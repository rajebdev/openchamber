...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolPart.codesearchResults': '在 {files} 個檔案中找到 {count} 個符合項目',
  'chat.toolPart.contentType': '內容類型: {type}',
  'chat.toolPart.structuredData': '結構化資料',
  'chat.toolPart.enteringPlanMode': '進入規劃模式',
  'chat.toolPart.exitingPlanMode': '退出規劃模式',
  'chat.toolPart.taskRunning': '任務執行中',
  'chat.toolPart.taskCompleted': '任務已完成',
  'chat.toolPart.monitorOutput': '監視器輸出',
  'chat.toolPart.renameCompleted': '重新命名已完成',
  'chat.toolPart.renameAvailable': '可重新命名',
  'chat.toolPart.editFailed': '編輯失敗',
  'chat.toolPart.editApplied': '編輯已套用',
  'chat.toolPart.foundReferences': '找到 {count} 個參考',
  'chat.todo.total': '總計',
