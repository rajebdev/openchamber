...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolPart.codesearchResults': '{files}개 파일에서 {count}개 일치 항목 발견',
  'chat.toolPart.contentType': '콘텐츠 유형: {type}',
  'chat.toolPart.structuredData': '구조화된 데이터',
  'chat.toolPart.enteringPlanMode': '계획 모드 진입 중',
  'chat.toolPart.exitingPlanMode': '계획 모드 종료 중',
  'chat.toolPart.taskRunning': '작업 실행 중',
  'chat.toolPart.taskCompleted': '작업 완료됨',
  'chat.toolPart.monitorOutput': '모니터 출력',
  'chat.toolPart.renameCompleted': '이름 변경 완료됨',
  'chat.toolPart.renameAvailable': '이름 변경 가능',
  'chat.toolPart.editFailed': '편집 실패',
  'chat.toolPart.editApplied': '편집 적용됨',
  'chat.toolPart.foundReferences': '{count}개 참조 발견',
  'chat.todo.total': '전체',
