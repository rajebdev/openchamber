...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolPart.codesearchResults': 'Znaleziono {count} dopasowanie/dopasowań w {files} pliku/plikach',
  'chat.toolPart.contentType': 'Typ treści: {type}',
  'chat.toolPart.structuredData': 'Dane strukturalne',
  'chat.toolPart.enteringPlanMode': 'Wchodzenie w tryb planowania',
  'chat.toolPart.exitingPlanMode': 'Wychodzenie z trybu planowania',
  'chat.toolPart.taskRunning': 'Zadanie w trakcie',
  'chat.toolPart.taskCompleted': 'Zadanie ukończone',
  'chat.toolPart.monitorOutput': 'Wyjście monitora',
  'chat.toolPart.renameCompleted': 'Zmiana nazwy ukończona',
  'chat.toolPart.renameAvailable': 'Zmiana nazwy dostępna',
  'chat.toolPart.editFailed': 'Edycja nieudana',
  'chat.toolPart.editApplied': 'Edycja zastosowana',
  'chat.toolPart.foundReferences': 'Znaleziono {count} odniesienie/odniesień',
