...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.toolPart.codesearchResults": "Se encontraron {count} coincidencia(s) en {files} archivo(s)",
  "chat.toolPart.contentType": "Tipo de contenido: {type}",
  "chat.toolPart.structuredData": "Datos estructurados",
  "chat.toolPart.enteringPlanMode": "Entrando en modo planificación",
  "chat.toolPart.exitingPlanMode": "Saliendo del modo planificación",
  "chat.toolPart.taskRunning": "Tarea en ejecución",
  "chat.toolPart.taskCompleted": "Tarea completada",
  "chat.toolPart.monitorOutput": "Salida del monitor",
  "chat.toolPart.renameCompleted": "Renombrado completado",
  "chat.toolPart.renameAvailable": "Renombrado disponible",
  "chat.toolPart.editFailed": "Edición fallida",
  "chat.toolPart.editApplied": "Edición aplicada",
  "chat.toolPart.foundReferences": "Se encontraron {count} referencia(s)",
