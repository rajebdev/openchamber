...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.toolPart.codesearchResults": "Encontrado(s) {count} correspondência(s) em {files} arquivo(s)",
  'chat.toolPart.contentType': 'Tipo de conteúdo: {type}',
  "chat.toolPart.structuredData": "Dados estruturados",
  "chat.toolPart.enteringPlanMode": "Entrando no modo de planejamento",
  "chat.toolPart.exitingPlanMode": "Saindo do modo de planejamento",
  "chat.toolPart.taskRunning": "Tarefa em execução",
  "chat.toolPart.taskCompleted": "Tarefa concluída",
  "chat.toolPart.monitorOutput": "Saída do monitor",
  "chat.toolPart.renameCompleted": "Renomeação concluída",
  "chat.toolPart.renameAvailable": "Renomeação disponível",
  "chat.toolPart.editFailed": "Edição falhou",
  "chat.toolPart.editApplied": "Edição aplicada",
  "chat.toolPart.foundReferences": "Encontrado(s) {count} referência(s)",
