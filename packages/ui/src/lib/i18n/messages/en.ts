...
export const dict = {
  ...
  'chat.toolPart.codesearchResults': 'Found {count} match(es) in {files} file(s)',
  'chat.toolPart.contentType': 'Content type: {type}',
  'chat.toolPart.structuredData': 'Structured data',
  'chat.toolPart.enteringPlanMode': 'Entering planning mode',
  'chat.toolPart.exitingPlanMode': 'Exiting planning mode',
  'chat.toolPart.taskRunning': 'Task Running',
  'chat.toolPart.taskCompleted': 'Task Completed',
  'chat.toolPart.monitorOutput': 'Monitor Output',
  'chat.toolPart.renameCompleted': 'Rename completed',
  'chat.toolPart.renameAvailable': 'Rename available',
  'chat.toolPart.editFailed': 'Edit Failed',
  'chat.toolPart.editApplied': 'Edit Applied',
  'chat.toolPart.foundReferences': 'Found {count} reference(s)',
